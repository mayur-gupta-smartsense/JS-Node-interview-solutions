...
class Motorcycle extends Vehicles {
	...
	hearMe() {
		console.log(
			` My vehicle is color: ${this.topSpeed} and brand: ${this.brand}`
		);
	}
}
...
/**
 * Make a class Emitter
 * const emitter = new Emitter();
Make emitter class in js.
...
//#StaticQ1
/**
 * Without using a global variable, make a counter that is invoked everytime a function call is made inside a class.
 *
 */
